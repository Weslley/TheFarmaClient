"""
Django settings for thefarmacustomer project.
...
SECRET_KEY = '6zic-agc@k*@)f&_v9@%+7p926krw9m&^5diq=r&liddyg7p-6'
...
WSGI_APPLICATION = 'thefarmacustomer.wsgi.application'
